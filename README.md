...
Nrfr 是一款强大的 SIM 卡国家码修改工具。Android 15 及以下通过 Shizuku 工作（无需 Root），Android 16+ 需要 Root 权限。本项目完全基于 Android 系统原生 API 实现，不依赖 Xposed、Magisk 等任何第三方框架，仅通过调用系统级接口实现功能。通过修改国家码，你可以：
...
- ✅ **Android 16 适配**：支持 Android 16 系统
- ✅ **TikTok 完整兼容**：新增 MCC/MNC 修改，解决 TikTok 地区限制
- ✅ **开机自启**：保存后重启自动生效（需 KernelSU/SukiSU）
- ✅ **双卡完整支持**：同时修改两张 SIM 卡
...
| Android 版本 | 权限要求 | 功能 |
|-------------|----------|------|
| Android 15 及以下 | Shizuku（免 Root） | 完整功能 |
| Android 16+ | Root + Shizuku | 完整功能 |
